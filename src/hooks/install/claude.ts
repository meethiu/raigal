...
// Files where a change outside the agent's edit cycle should refresh baseline.
// FileChanged matchers accept pipe-separated literal filenames only - no globs.
const FILE_CHANGED_MATCHER =
	".raigal/config.yml|.raigal/rules.yml|.aislop/config.yml|.aislop/rules.yml|package.json";
