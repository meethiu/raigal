...
```bash
git clone https://github.com/meethiu/raigal.git
cd raigal
pnpm install
```
...
Open a [bug report](https://github.com/meethiu/raigal/issues/new?template=bug_report.yml). Include:

- What you ran
- What happened vs. what you expected
- `raigal` version (`raigal --version`)
- Node version, OS, package manager

### Suggesting features

Open a [feature request](https://github.com/meethiu/raigal/issues/new?template=feature_request.yml). Describe the problem it solves and give an example of the pattern you want detected.
